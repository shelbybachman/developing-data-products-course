...
For example, to explore **density** values for white vinho verde wines, you could use the first tab. After selecting relevant preferences, the app will display 4 visualizations. including the plots below, that allow for exploration fo the variable:
